					...
					<div class="kt-content kt-content--fit-top  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="kt-portlet kt-portlet--mobile">
								...
								<?php echo form_open('admin/master_golongan/simpan','class="form-horizontal"'); ?>
								...
								<div class="kt-portlet__body">
									<div class="kt-form col-lg-8">
										...
										<div class="form-group row">
											...
											<div class="col-5">
												<input class="form-control" name="golongan" id="golongan" type="text" value="<?php echo $golongan; ?>" />
											</div>
										</div>
										<div class="form-group row">
											<label class="col-3 col-form-label kt-font-bolder">Uraian</label>
											<div class="col-7">
												<textarea cols="3" class="form-control" name="uraian" id="uraian"><?php echo $uraian; ?></textarea>
											</div>
										</div>
										<div class="form-group row">
