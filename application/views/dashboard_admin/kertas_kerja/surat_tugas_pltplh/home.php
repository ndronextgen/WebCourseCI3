...
<body style="background-image: url(<?php echo base_url().'assets_admin/media/bg/header.jpg'; ?>); background-position: center top; background-size: 100% 350px;" class="kt-page--loading-enabled kt-page--loading kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="kt-portlet kt-portlet--mobile">
								...
								<div class="kt-portlet__head kt-portlet__head--md">
									<div class="kt-portlet__head-label">
										<h4 class="kt-portlet__head-title" style='font-size:12px;'>
											<?php echo $deskripsi; ?>
								...
								<div class="kt-portlet__body">
									...
									<!--end: Search Form -->
									<?php echo form_open(base_url().'admin/surat_tugas_pltplh','class="form-horizontal" id="frmSuratTugasPltPlh"'); ?>
									<input type="hidden" name="id_pegawai" id="id_pegawai" />
									<!--begin: Datatable -->
									<div class="kt-portlet__body kt-portlet__body--fit">
										<div class="kt-datatable" id="tblTugasPltPlh"></div>
									</div>
									<!--end: Datatable -->
									<?php echo form_close(); ?>
								</div>
	...
	<!-- begin script page -->
	<script src="<?php echo base_url()?>assets_admin/js/pages/custom/tables/surat_tugas_pltplh.js" type="text/javascript"></script>
	<!-- end script page -->
</body>