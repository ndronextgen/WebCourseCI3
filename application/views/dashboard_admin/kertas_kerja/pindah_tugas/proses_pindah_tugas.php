<div class="panel-group">
    <div class="panel panel-default">
        ...
        <div id="detail_pengaduan" class="panel-collapse expand collapse show">
            ...
            <input type='hidden' value='<?php echo $Pindah_tugas_id; ?>' name='Pindah_tugas_id' id='Pindah_tugas_id'>
            <table class='table no-border' cellspacing='10' cellpadding='5'>
                ...
                <tr>
                    <td>Pindah Tugas</td>
                    <td>:</td>
                    <td><?php echo $Data_pindah_tugas->Keterangan; ?></td>
                </tr>
...
if (($id_lokasi_kerja == '0' || $id_lokasi_kerja == '' || $id_lokasi_kerja == '52')) { //admin-utama
    ?>
    <?php if ($Data_pindah_tugas->Status_progress == '0' || $Data_pindah_tugas->Status_progress == '25' || $Data_pindah_tugas->Status_progress == '28') { ?>
        ...
        <form id="form_verifikasi_pindah_tugas" name="form_verifikasi_pindah_tugas" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <button type="button" id='btn_verifikasi' style='float:right;' class="btn btn-success  btn-sm" onclick="simpan_verifikasi_pindah_tugas()"><i class="fa fa-save"></i> Simpan & Kirim Ketahap Selanjutnya</button>&nbsp;&nbsp;
                        <button type="button" style='float:right;' class="btn btn-danger btn-sm" onclick="batal_form()">Batal</button>&nbsp;&nbsp;
                    </div>
                </div>
            </div>
        </form>
    <?php } elseif ($Data_pindah_tugas->Status_progress == '3') { ?>
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
