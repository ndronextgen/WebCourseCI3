													...
													echo '<div class="kt-grid__item">';
														echo '<div class="kt-wizard-v1__nav">';
															...
															foreach ($Query_history as $hist) {
																...
																if($hist->id_status_srt=='2'){ //sedang diproses
																...
																if($hist->id_status_srt=='3' AND $surat->select_ttd=='digital'){ //sedang diproses
																	//$download_file .= '<a href="javascript:;" onclick="download_surat_digital('.$surat->id_srt.')" class="btn btn-danger btn-sm"><i class="flaticon-download"></i> Download Surat</a>&nbsp;&nbsp;';
																}
													...
													<div class="row" align="center">
														<div class="col-lg-12" align="center">
															...
															if ($surat->id_status_srt == 0) {
																...
																//sedang diproses
																if ($surat->file_name == '' || $surat->file_name == null) {
																	//echo '<a href="javascript:;" onclick="download_surat('.$surat->id_srt.')" class="btn btn-brand"><i class="flaticon-download"></i> Download Surat</a>&nbsp;&nbsp;';
																}
