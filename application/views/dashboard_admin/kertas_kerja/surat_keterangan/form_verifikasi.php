...
<div class="kt-radio-inline">
	...
	<input type="radio" name="dec" value="<?php echo $terima; ?>" onclick="changeStatus(2);"> Diterima
	<span></span>
	</label>
	<label class="kt-radio kt-radio--bold kt-radio--brand">
	<input type="radio" name="dec" value="<?php echo $tolak; ?>" onclick="changeStatus(1);"> Ditolak
	<span></span>
	</label>
</div>
</div>
