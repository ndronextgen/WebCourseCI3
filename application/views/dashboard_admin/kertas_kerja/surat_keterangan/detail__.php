					...
					<div class="kt-content kt-content--fit-top  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="kt-portlet kt-portlet--mobile">
								...
								<input type="text" name="id_surat" id="id_surat" value="<?php echo (isset($surat->id_srt) ? $surat->id_srt : 0);?>" />
								<input type="text" name="id_user" id="id_user" value="<?php echo (isset($surat->id_user) ? $surat->id_user : 0);?>" />
									...
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="kt-portlet__body">
													...
													if ($surat->id_status_srt == 2 || $surat->id_status_srt == 3) {
															...
															echo '<div class="kt-grid__item">';
																echo '<div class="kt-wizard-v1__nav">';
																	...
																	foreach ($status_surat as $hist) {
																		...
																		if ($hist->active == 1) {
																			$active = 'current';
																			$txt .= '<div class="kt-wizard-v2__nav-label-desc">'.$hist->created_by.'<br />'.$hist->created_at.'</div>';
																			$download_file .= '<a href="javascript:;" onclick="download_surat('.$surat->id_srt.')" class="btn btn-danger"><i class="flaticon-download"></i> Download Surat</a>&nbsp;&nbsp;';
																		}
																		else {
																			if ($surat->id_status_srt == 1) {
																				//jika ditolak
																			...
																			$txt .= '<div class="kt-wizard-v2__nav-label-desc"><br />&nbsp;</div>';
																			$download_file .= '';
																		}
																		...
																		echo '<div class="kt-wizard-v1__nav-item" data-ktwizard-type="step" data-ktwizard-state="'.$active.'">
																				<div class="kt-wizard-v1__nav-body">
																					...
																					<div class="kt-wizard-v1__nav-label">'.$hist->status_srt.'</div>
																					'.$txt.'<br>
																				</div>
																			</div>';
												...
												<div class="kt-portlet__foot" align="center">
													...
													<div class="row" align="center">
														<div class="col-lg-12" align="center">
															...
															else if ($surat->id_status_srt == 2) {
																//sedang diproses
																if ($surat->file_name == '' || $surat->file_name == null) {
																	echo '<a href="javascript:;" onclick="download_surat('.$surat->id_srt.')" class="btn btn-danger"><i class="flaticon-download"></i> Download Surat</a>&nbsp;&nbsp;';
																}

																if ($surat->is_download > 0) {
																	//sudah pernah download
