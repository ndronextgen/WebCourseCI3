...
<body style="background-image: url(<?php echo base_url() . 'assets_admin/media/bg/header.jpg'; ?>); background-position: center top; background-size: 100% 350px;" class="kt-page--loading-enabled kt-page--loading kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
	...
	<script type="text/javascript">
		function load_data_pltplh() {
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('admin/Data_pltplh/filter') ?>",
		...
		function reload_table() {
			tablepltplh.ajax.reload(null, false); //reload datatable ajax 
		}
		...
		function simpan_pengajuan() {
			...
			var formData = new FormData($('#form_pltplh')[0]);
			var url = "<?php echo site_url('admin/Data_pltplh/simpan_validasi'); ?>";
		...
		function ajax_simpan_pengajuan() {
			...
			if (save_method == 'tambah') {
				url = "<?php echo site_url('admin/Data_pltplh/simpan_tambah'); ?>";
			} else if (save_method == 'edit') {
				url = "<?php echo site_url('admin/Data_pltplh/simpan_edit'); ?>";
			}
		...
		function delete_pltplh(id_surat_tugas_pltplh) {
			
			var q = "Hapus data PLT/PLH?";
					...
					yes: {
						...
						action: function() {
							$.ajax({
								...
								url: "<?php echo site_url('admin/Data_pltplh/delete_pltplh') ?>",
								success: function(s) {
									$jQ.dialog({
										title: 'Info',
										content: i,
