	...
	<div class="row" style='padding:0px;'>
			...
			<div class="col-6">
				<div class="form-group">
					...
					<input type='text' id="lokasi_kerja_pltplh" name="lokasi_kerja_pltplh" class="form-control avoid-clicks">
				</div>
			</div>
		...
		<div class="row" style='padding:0px;'>
			...
			<div class="col-8">
				<div class="form-group">
					...
					<input type='text' id="lokasi_kerja_berhalangan" name="lokasi_kerja_berhalangan" class="form-control avoid-clicks">
				</div>
			</div>
		...
		<div class="row" style='padding:0px;'>
			...
			<div class="col-2">
				<div class="form-group">
					...
					<input type='text' class="form-control tgl_mulai" id="tgl_mulai" name='tgl_mulai' value=''>
				</div>
			</div>
			...
			<div class="col-2">
				<div class="form-group">
					...
					<input type='text' class="form-control tgl_selesai" id="tgl_selesai" name='tgl_selesai' value=''>
				</div>
			</div>
			<div class="col-2" id='lama_durasi'>
				<div class="form-group">
					<label>Lama (Hari) :</label>
					<input type='number' class="form-control avoid-clicks" id="durasi" name='durasi'>
				</div>
			</div>
		</div>
