...
$pdf->SetTitle('Surat Usulan Calon Penerima Pensiun ' . $title);
  ...
  <div class="content">
    <table class="table-main">
      <tr>
        ...
        <td class="header1">' . $header_surat1 . '</td>
      </tr>
      ' . $header2 . '
      <tr>
...
if (count($pegawai) > 1) {
	...
	$html .= '
            <tr>
              <td class="cell-name">Nama</td>
              <td class="cell-space">:</td>
              <td class="cell-val">' . ucwords(strtolower($pegawai[0]['pegawai']->nama_pegawai)) . '</td>
            </tr>
            <tr>
              <td class="cell-name">NIP / NRK</td>
              <td class="cell-space">:</td>
...
$html .= '<td colspan="5">Demikian surat keterangan ini dibuat dengan sebenarnya dan digunakan untuk ' . $surat->keterangan . '.</td>
      </tr>
    </table>
    <br /><br />
    <table class="table-main">
...
$filename = 'surat_usulan_calon_penerima_pensiun_' . str_replace(' ', '_', $namaFile) . '.pdf';
ob_end_clean();
