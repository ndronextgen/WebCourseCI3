    ...
    <table>
      ...
      <tr>
        ...
        <td colspan="3" class="val2"><ol style="text-align: justify;">
                        <li>Melaksanakan tugas sebagai Pelaksana Harian '. ucwords(strtolower($filter_lokasi_kerja)) .' disamping tugas pokoknya sebagai '.ucwords(strtolower($pegawai->nama_jabatan)).' '.ucwords(strtolower($pegawai->lokasi_kerja)).', terhitung mulai tanggal '.$tgl_mulai.' sampai dengan tanggal '.$tgl_selesai.'.</li>
