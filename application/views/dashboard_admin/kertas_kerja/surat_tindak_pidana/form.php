...
<body style="background-image: url(<?php echo base_url().'assets_admin/media/bg/header.jpg'; ?>); background-position: center top; background-size: 100% 350px;" class="kt-page--loading-enabled kt-page--loading kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head">
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<a href="javascript:;" onclick="backSuratTindakPidana('<?php echo $act;?>');" class="btn btn-clean btn-icon-sm">
								...
								<div class="kt-portlet__body">
									<div class="col-lg-12">
										...
										?>
										<?php echo form_open(base_url().'admin/surat_tindak_pidana/simpan','class="form-horizontal" id="formSuratTindakPidana"'); ?>
										<input type="hidden" name="counterFrmSuratTindakPidana" id="counterFrmSuratTindakPidana" value="1" />
										<input type="hidden" name="id_pegawai" id="id_pegawai" value="<?php echo (isset($pegawai->id_pegawai) ? $pegawai->id_pegawai : 0);?>" />
										<input type="hidden" name="id_surat_tindak_pidana" id="id_surat_tindak_pidana" value="<?php echo (isset($surat->id_surat_tindak_pidana) ? $surat->id_surat_tindak_pidana : 0);?>" />
										...
										<div class="kt-portlet__body kt-portlet__body--fit">
											...
											<div class="form-group form-group-last row">
												...
												<div class="col-lg-12">
													<a href="javascript:;" onclick="addFrmSuratTindakPidana(this);" class="btn btn-bold btn-sm btn-label-brand" id="btnAddSuratTindakPidana">
										...
										<div class="kt-portlet__foot" align="center">
											...
											<div class="row" align="center">
												<div class="col-ld-12" align="center">
													...
													<a href="<?php echo base_url();?>admin/surat_tindak_pidana" class="btn btn-secondary">
														Batal
													</a>
												</div>
											</div>
	...
	<!-- begin script page -->
	<script src="<?php echo base_url()?>assets_admin/js/pages/custom/form/surat_tindak_pidana.js" type="text/javascript"></script>
	<!-- end script page -->
</body>
