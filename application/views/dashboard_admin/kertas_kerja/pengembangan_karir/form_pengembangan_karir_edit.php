		...
		<div class="row" style='padding:0px;'>
			...
			<div class="col-12">
				<div class="form-group">
					...
					<textarea name="Keterangan" id="Keterangan" class="form-control input-sm custom-placeholder" placeholder='Telah memperoleh ijazah Strata I Program Studi Teknik Informarmatika Universitas Mercu Buana'><?php echo $Data->Keterangan; ?></textarea>
				</div>
			</div>
			...
			<div class="col-3">
				<div class="form-group">
					...
					<!-- <input type='text' name='Periode_awal' value="<?php //echo $Data->Periode_awal; 
																		?>" class="form-control input-sm" id='Periode_awal' maxlength="4" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"> -->
				</div>
			</div>
			<div class="col-3">
				<div class="form-group">
					...
					<!-- <input type='text' name='Periode_akhir' value="<?php //echo $Data->Periode_akhir; 
																		?>" class="form-control input-sm" id='Periode_akhir' maxlength="4" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"> -->
				</div>
			</div>
			<div class="col-6">
				<div class="form-group">
					<label>Digunakan Untuk ?</label>
					<input type='text' name='Keperluan' class="form-control input-sm custom-placeholder" id='Keperluan' value="<?php echo $Data->Keperluan; ?>" placeholder='kelengkapan administrasi pencantuman gelar;'>
				</div>
			</div>
