...
<div class="row" style='padding:0px;'>
	...
	<div class="col-12">
		<div class="form-group">
			...
			<textarea name="Keterangan" id="Keterangan" class="form-control input-sm" placeholder='Telah memperoleh ijazah Strata I Program Studi Teknik Informarmatika Universitas Mercu Buana'></textarea>
		</div>
	</div>
	...
	<div class="col-6">
		<div class="form-group">
			...
			<input type='text' name='Keperluan' class="form-control input-sm" id='Keperluan' placeholder='kelengkapan administrasi pencantuman gelar;'>
		</div>
	</div>
...
<script>
	...
	$.ajax({
			...
			data : {lokasi_kerja:filter_lokasi_kerja},
