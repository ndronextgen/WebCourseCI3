...
.avoid-clicks {
  ...
  cursor: no-drop;
							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head">
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<a href="javascript:;" onclick="backSuratNaikPangkat('<?php echo $act;?>');" class="btn btn-clean btn-icon-sm">
								...
								<div class="kt-portlet__body">
									<div class="col-lg-12">
										...
										<?php echo form_open(base_url().'admin/surat_naik_pangkat/simpan','class="form-horizontal" id="frmSuratNaikPangkat"'); ?>
										...
										<div class="kt-portlet__foot" align="center">
											...
											<div class="row" align="center">
												<div class="col-ld-12" align="center">
													...
													<a href="<?php echo base_url();?>admin/surat_naik_pangkat" class="btn btn-secondary">
														Batal
													</a>
												</div>
											</div>
	...
	<!-- begin script page -->
	<script src="<?php echo base_url()?>assets_admin/js/pages/custom/form/surat_naik_pangkat.js" type="text/javascript"></script>
	<!-- end script page -->
	<script>
	//onload
	...
	$.ajax({
			type : "POST",
			url : "<?php echo site_url('admin/Surat_naik_pangkat/filter_lk') ?>",
