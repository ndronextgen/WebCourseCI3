...
<body style="background-image: url(<?php echo base_url().'assets_admin/media/bg/header.jpg'; ?>); background-position: center top; background-size: 100% 350px;" class="kt-page--loading-enabled kt-page--loading kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
					...
					<div class="kt-content kt-content--fit-top  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<a href="javascript:;" onclick="backSuratNaikPangkat();" class="btn btn-clean btn-icon-sm">
								...
								<?php echo form_open_multipart("admin/surat_keterangan/simpan",'name="frmSuratNaikPangkat" id="frmSuratNaikPangkat" method="post"'); ?>
								<input type="hidden" name="id_surat" id="id_surat" value="<?php echo (isset($surat->id_surat_naik_pangkat) ? $surat->id_surat_naik_pangkat : 0);?>" />
											...
											<div class="kt-form">
												<div class="kt-portlet__body">
													...
													<div class="form-group form-group-xs row">
														...
														<div class="col-9">
															<a href="javascript:;" onclick="download_surat('<?php echo $surat->id_surat_naik_pangkat;?>')"> Download Surat <i class="flaticon-download"></i></a>
														</div>
													</div>
												</div>
											</div>
	...
	<!-- begin script page -->
	<script src="<?php echo base_url()?>assets_admin/js/pages/custom/form/surat_naik_pangkat_detail.js" type="text/javascript"></script>
	<!-- end script page -->
</body>