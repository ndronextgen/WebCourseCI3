...
<body style="background-image: url(<?php echo base_url().'assets_admin/media/bg/header.jpg'; ?>); background-position: center top; background-size: 100% 350px;" class="kt-page--loading-enabled kt-page--loading kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<a href="<?php echo base_url();?>admin/surat_naik_pangkat" class="btn btn-clean btn-icon-sm">
												<i class="la la-long-arrow-left"></i>
												Kembali
											</a>
											&nbsp;
											<button type="button" class="btn btn-primary" onclick="buatSuratNaikPangkat();">
												<i class="flaticon-file-1"></i> Buat Surat
											</button>
										</div>
									</div>
								</div>
								<?php echo form_open("admin/surat_naik_pangkat",'name="frmSuratNaikPangkat" id="frmSuratNaikPangkat" method="post"'); ?>
								...
								<div class="kt-portlet__body kt-portlet__body--fit">
									<!--begin: Datatable -->
									<div class="kt-datatable" id="tblNaikPangkatList"></div>
									<!--end: Datatable -->
								</div>
								<?php echo form_close(); ?>
							</div>
	...
	<!-- begin script page -->
	<script src="<?php echo base_url()?>assets_admin/js/pages/custom/tables/surat_naik_pangkat_list.js" type="text/javascript"></script>
	<!-- end script page -->
</body>