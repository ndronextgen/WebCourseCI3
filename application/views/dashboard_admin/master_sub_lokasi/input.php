					...
					<div class="kt-content kt-content--fit-top  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="kt-portlet kt-portlet--mobile">
								...
								<?php echo form_open('admin/master_sub_lokasi/simpan','class="form-horizontal"'); ?>
								...
								<div class="kt-portlet__body">
									<div class="kt-form col-lg-8">
										...
										<div class="form-group row">
											<label class="col-3 col-form-label kt-font-bolder">Nama Seksi/ Subbag/ Satlak</label>
											<div class="col-7">
												<input class="form-control" name="sub_lokasi_kerja" id="sub_lokasi_kerja" type="text" value="<?php echo $sub_lokasi_kerja; ?>" />
											</div>
										</div>
										<div class="form-group row">
