...
<style type="text/css">
	.td_head{
		font-weight:bold;background-color: #7d7d7d;color:#fff !important;
		font-size: 12px;
	}
...
table = $('#table_laporan').DataTable({ 
  ...
  "ajax": {
    ...
    "aoColumns": [ {"sClass":"center"},{"sClass":"center"},{"sClass":"center"},{"sClass":"center"},{"sClass":"left"},{"sClass":"center"},{"sClass":"center"},{"sClass":"center"}],
  language: {
         processing: 'Memuat...',
     },
