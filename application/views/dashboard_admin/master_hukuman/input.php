					...
					<div class="kt-content kt-content--fit-top  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<a href="<?php echo base_url();?>admin/master_hukuman" class="btn btn-clean btn-icon-sm">
								...
								<?php echo form_open('admin/master_hukuman/simpan','class="form-horizontal"'); ?>
								...
								<div class="kt-portlet__body">
									<div class="kt-form col-lg-8">
										...
										<div class="form-group row">
											<label class="col-3 col-form-label kt-font-bolder">Nama Hukuman</label>
											<div class="col-7">
												<input class="form-control" name="nama_hukuman" id="nama_hukuman" type="text" value="<?php echo $nama_hukuman; ?>" />
											</div>
										</div>
									</div>
								</div>
