							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<div class="kt-portlet__body">
									<div class="kt-form col-lg-8">
										...
										<p style="color:#e80e41;font-weight: bold;">*) Password akan digenerate Otomatis Oleh System, Menjadi Sama Dengan Username</p>
										<div class="form-group row">
										...
										<div class="form-group row" style="display:none;">
											...
											<div class="col-5">
												<input class="form-control" name="password" id="password" type="password" autocomplete='off' value="123456" />
											</div>
										</div>
									</div>
								</div>
