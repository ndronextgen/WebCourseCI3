            ...
            <ul class="nav">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="<?php echo base_url(); ?>admin/master_pelatihan"><i class="icon-folder-open"></i> Pelatihan</a></li>
                  ...
                  <li><a href="<?php echo base_url(); ?>admin/master_lokasi_pelatihan"><i class="icon-fullscreen"></i> Lokasi Pelatihan</a></li>
                  <li><a href="<?php echo base_url(); ?>admin/master_lokasi_kerja"><i class="icon-briefcase"></i> Lokasi Kerja</a></li>
				  <li><a href="<?php echo base_url(); ?>admin/master_bidang"><i class="icon-briefcase"></i> Bidang</a></li>
                </ul>
              </li>
			  <li class="dropdown">
