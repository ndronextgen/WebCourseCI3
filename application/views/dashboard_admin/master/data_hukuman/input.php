...
<html lang="en">
  ...
  <body>
	...
	<?php } ?>
		<?php echo form_open('admin/data_hukuman/simpan','class="form-horizontal"'); ?>
		  <div class="control-group">
		  	<legend>Tambah Data Hukuman - <?php echo $this->session->userdata("nama_pegawai"); ?></legend>
			<label class="span3" for="id_master_hukuman">Hukuman</label>
			<div class="controls">
			  <select name="id_master_hukuman" id="id_master_hukuman" data-placeholder="Hukuman" class="js-example-basic-single span6 input-lg">
			<option value=""></option>
			  	<?php
		  ...
		  <div class="control-group">
			<label class="span3" for="tanggal_mulai">Tanggal Mulai</label>
			<div class="controls">
		  ...
		  <div class="control-group">
			<label class="span3" for="tanggal_selesai">Tanggal Selesai</label>
			<div class="controls">
		  ...
		  <div class="control-group">
			<label class="span3" for="masa_berlaku">Masa Berlaku</label>
			<div class="controls">
		  ...
		  <div class="control-group">
			<label class="span3" for="pejabat_menetapkan">Pejabat yang Menetapkan</label>
			<div class="controls">
		  ...
		  <div class="control-group">
			<div class="controls">
			  ...
			  <button type="reset" class="btn">Hapus Data</button>
			   <a href="<?php echo base_url(); ?>pegawai/edit/<?php echo $this->session->userdata('id_pegawai'); ?>#data-hukuman" class="red btn">Cancel</a>
			</div>
		  </div>
