...
<html lang="en">
  ...
  <body>
	...
	<?php } ?>
		<?php echo form_open('admin/data_riwayat_pangkat/simpan','class="form-horizontal"'); ?>
		  <div class="control-group">
		  	<legend>Tambah Data Riwayat Pangkat - <?php echo $this->session->userdata("nama_pegawai"); ?></legend>
		  ...
		  <div class="control-group">
			<label class="span3" for="lokasi_kerja">Lokasi Kerja</label>
			<div class="controls">
			  <input type="text" class="span6" name="lokasi_kerja" id="lokasi_kerja" value="<?php echo $lokasi_kerja; ?>" 
		  ...
		  <div class="control-group">
			<div class="controls">
			  ...
			  <a href="<?php echo base_url(); ?>pegawai/edit/<?php echo $this->session->userdata('id_pegawai'); ?>#data-pangkat" class="red btn">Cancel</a>
			</div>
		  </div>
