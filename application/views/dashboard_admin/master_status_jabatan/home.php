...
<html lang="en">
            ...
            <ul class="nav">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu">
				  ...
				  <li><a href="<?php echo base_url(); ?>master_bidang"><i class="icon-briefcase"></i> Bidang</a></li>
                </ul>
              </li>
			  <li class="dropdown">
			  	<a href="http://192.168.101.106/simpeg_cuti/form_cuti_index.php" class="" data-toggle="" target="_blank"><i class="icon-comment icon-white"></i> Cuti Pegawai <b class=""></b></a>
              </li>
			  <!-- <li class="dropdown">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu">
				  ...
				  <li><a href="<?php echo base_url(); ?>laporan_pegawai_status_golongan"><i class="icon-eye-open"></i> Laporan Pegawai - Golongan</a></li>
				  <li><a href="<?php echo base_url(); ?>laporan_pegawai_status_pegawai"><i class="icon-eye-open"></i> Laporan Pegawai - Status Pegawai</a></li>
				  <li><a href="<?php echo base_url(); ?>laporan_pegawai_pendidikan"><i class="icon-eye-open"></i> Laporan Pegawai - Pendidikan</a></li>
				  <li><a href="<?php echo base_url(); ?>laporan_pegawai_hukuman"><i class="icon-eye-open"></i> Laporan Pegawai - Hukuman</a></li>
				  <li><a href="<?php echo base_url(); ?>laporan_pegawai_jenis_kelamin"><i class="icon-eye-open"></i> Laporan Pegawai - Jenis Kelamin</a></li>
				  ...
				  <li><a href="<?php echo base_url(); ?>laporan_pegawai_tugas_izin_belajar"><i class="icon-ok-sign"></i> Laporan Pegawai - Tugas & Izin Belajar</a></li> 
                </ul>
              </li> 
            </ul>
  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		<div class="container">
		  <a class="brand" href="#">Master Status Jabatan</a>
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?php echo base_url(); ?>master_status_jabatan/tambah" class="small-box"><i class="icon-plus-sign icon-white"></i> Tambah Status Jabatan</a></li>
			</ul>
		  </div>
		<div class="span6 pull-right">
		<?php echo form_open('master_status_jabatan/cari','class="navbar-form pull-right"'); ?>
  ...
  <table class="table table-hover table-condensed">
	...
	?>
      <tr>
		...
		<td>
	        <div class="btn-group">
	          <a class="btn btn-small small-box" href="<?php echo base_url(); ?>master_status_jabatan/detail/<?php echo $dp['id_status_jabatan']; ?>"><i class="icon-ok-circle"></i> Lihat Detail</a>
	          <a class="btn btn-small dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="<?php echo base_url(); ?>master_status_jabatan/edit/<?php echo $dp['id_status_jabatan']; ?>" class="small-box"><i class="icon-pencil"></i> Edit Data</a></li>
	            <li><a href="<?php echo base_url(); ?>master_status_jabatan/hapus/<?php echo $dp['id_status_jabatan']; ?>" onClick="return confirm('Anda yakin..???');"><i class="icon-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
		</td>
      </tr>
