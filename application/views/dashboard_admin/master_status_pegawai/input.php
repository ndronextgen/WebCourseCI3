					...
					<div class="kt-content kt-content--fit-top  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<a href="<?php echo base_url();?>admin/master_status_pegawai" class="btn btn-clean btn-icon-sm">
								...
								<?php echo form_open('admin/master_status_pegawai/simpan','class="form-horizontal"'); ?>
								...
								<div class="kt-portlet__body">
									<div class="kt-form col-lg-8">
										...
										<div class="form-group row">
											<label class="col-3 col-form-label kt-font-bolder">Nama Status</label>
											<div class="col-5">
												<input class="form-control" name="nama_status" id="nama_status" type="text" value="<?php echo $nama_status; ?>" />
											</div>
										</div>
									</div>
								</div>
