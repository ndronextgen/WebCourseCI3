					...
					<div class="kt-content kt-content--fit-top  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-container  kt-grid__item kt-grid__item--fluid">
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<a href="<?php echo base_url();?>admin/master_lokasi_kerja" class="btn btn-clean btn-icon-sm">
								...
								<?php echo form_open('admin/master_lokasi_kerja/simpan','class="form-horizontal"'); ?>
								...
								<div class="kt-portlet__body">
									<div class="kt-form col-lg-8">
										...
										<div class="form-group row">
											<label class="col-3 col-form-label kt-font-bolder">Uraian Lokasi Kerja</label>
											<div class="col-7">
												<input class="form-control" name="lokasi_kerja" id="lokasi_kerja" type="text" value="<?php  echo $lokasi_kerja; ?>" />
											</div>
										</div>
										<!-- <div class="form-group row">
								...
								<div class="kt-portlet__foot" align="center">
									...
									<div class="row" align="center">
										<div class="col-lg-12" align="center">
											...
											&nbsp;
											<a href="<?php echo base_url();?>admin/master_sub_lokasi" class="btn btn-clean btn-icon-sm">
