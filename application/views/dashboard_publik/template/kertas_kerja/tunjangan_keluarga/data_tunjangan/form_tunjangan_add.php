            ...
            <div class="nav-tabs-custom">
                <div class="tab-content">
                    ...
                    <form name="form_tunjangan" id="form_tunjangan" method="post" enctype="multipart/form-data">
                        <button type='button' class='btn btn-success btn-sm' onclick='ubah_data_pegawai(<?php echo $id_pegawai; ?>)' style='float:left;'>
                            <i class="glyphicon glyphicon-edit"></i> &nbsp; Ubah Data Pegawai
                        </button>
                                ...
                                <td colspan='3'>
                                    ...
                                    <div class="table-responsive">
                                        <span>
                                            ...
                                            <button class='btn btn-danger btn-sm btn-flat' type='button' onclick="get_item('<?php echo $Data->id_pegawai; ?>', '<?php echo $Tunjangan_id; ?>')">
                                                <i class="glyphicon glyphicon-plus"></i> &nbsp; Tambah Penerima Tunjangan
                                            </button>
    ...
    <div>
        ...
        <script type="text/javascript">
            ...
            function ubah_data_pegawai(Id) {
                ...
                $('.modal-footer').hide(); // show bootstrap modal
                $('#modal_all').modal('show'); // show bootstrap modal
                $('.modal-title').text('Ubah Data Pegawai'); // Set Title to Bootstrap modal title
            }
