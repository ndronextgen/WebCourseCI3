                ...
                <div class="tab-content">
                    <div class="page-header">
                        <h4># Tambah Data Karis Karsu &nbsp;&nbsp;&nbsp;<button class='btn btn-info btn-sm' onclick='load_data()' style='float:right;'>
                                << Kembali</button> </h4> </div> <form name="form_kariskarsu" id="form_kariskarsu" method="post" enctype="multipart/form-data">
                                    ...
                                    <button type='button' class='btn btn-success btn-sm' onclick='ubah_data_pegawai(<?php echo $Data->id_pegawai; ?>)' style='float:right;'><i class="glyphicon glyphicon-edit"></i> Ubah Data Pegawai</button>
