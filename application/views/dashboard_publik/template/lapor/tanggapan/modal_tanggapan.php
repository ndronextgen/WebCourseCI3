...
<div class="box">
    <div class="box-header" align="center">
        ...
        <div class="label bg-aqua" style="font-size: 14px; font-weight: normal;">Form Input Tanggapan</div>
        <!-- </div> -->
    </div>
    <div class="box-body">
    ...
    <div class="box-footer pull-right">
        <button class="btn btn-sm btn-success btn-flat" onclick="simpan_tanggapan()" id="btn_simpan">Simpan Tanggapan</button>
