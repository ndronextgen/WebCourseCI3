...
<div class="box box-info">
    ...
    <div class="box-body">
        <form id="form_verifikasi_pindah_tugas_kep" name="form_verifikasi_pindah_tugas_kep" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
...
<div class="control-group">
    <button type="button" style='float: right; margin-top: -5px; margin-right: 0px;' class="btn btn-danger btn-sm" onclick="tutup_form_detail()">
