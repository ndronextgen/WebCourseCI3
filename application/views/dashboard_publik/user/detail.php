								...
								<div class="kt-portlet__body">
									<div class="kt-form col-lg-8">
										<div class="form-group row">
											...
											<div class="col-5">
												<input class="form-control" name="nama_lengkap" id="nama_lengkap" type="text" value="<?php echo $nama_lengkap; ?>" disabled />
											</div>
										</div>
										<div class="form-group row">
											<label class="col-3 col-form-label kt-font-bolder">Username</label>
											<div class="col-5">
												<input class="form-control" name="username" id="username" type="text" value="<?php echo $username; ?>" disabled />
											</div>
										</div>
										<div class="form-group row">
											<label class="col-3 col-form-label kt-font-bolder">Email</label>
											<div class="col-5">
												<input class="form-control" name="email" id="email" type="text" value="<?php echo $email; ?>" disabled />
											</div>
										</div>
										<div class="form-group row">
											<label class="col-3 col-form-label kt-font-bolder">Lokasi Kerja</label>
											<div class="col-9">
												<textarea rows="3" class="form-control" name="lokasi_kerja" id="lokasi_kerja" disabled><?php echo $lokasi_kerja; ?></textarea>
											</div>
										</div>
									</div>
								</div>
