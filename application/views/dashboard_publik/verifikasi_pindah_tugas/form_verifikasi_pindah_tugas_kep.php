...
<div class="box box-info">
    ...
    <div class="box-body">
        <form id="form_verifikasi_pindah_tugas_kep" name="form_verifikasi_pindah_tugas_kep" method="post">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <button id='btn_tmb' type='button' onclick="simpan_verifikasi_pindah_tugas()" class='btn btn-block btn-success btn-md'>Verifikasi</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
