...
class Surat_penyesuaian_ijazah extends CI_Controller {
	...
	public function list() {
		...
		$q = "select a.id_pegawai, a.nip, a.nrk, a.nama_pegawai, 
				(select count(0) from tbl_data_surat_penyesuaian_ijazah where tbl_data_surat_penyesuaian_ijazah.id_pegawai = a.id_pegawai) as count_surat,
				(select date_created from tbl_data_surat_penyesuaian_ijazah where tbl_data_surat_penyesuaian_ijazah.id_pegawai = a.id_pegawai order by date_created desc limit 1) as date_created
	...
	public function list_detail() {
		...
		$q = "select * 
				from tbl_data_surat_penyesuaian_ijazah 
	...
	public function detail() {
		...
		$q = "select * 
				from tbl_data_surat_penyesuaian_ijazah 
				where id_surat_penyesuaian_ijazah=".$id_surat;
