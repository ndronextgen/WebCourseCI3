...
class Surat_tugas_plh extends CI_Controller {
	...
	public function listing() {
		...
		$q = "select a.id_pegawai, a.nip, a.nrk, a.nama_pegawai, 
				(select count(0) from tbl_data_surat_tugas_plh where tbl_data_surat_tugas_plh.id_pegawai = a.id_pegawai) as count_surat,
				(select date_created from tbl_data_surat_tugas_plh where tbl_data_surat_tugas_plh.id_pegawai = a.id_pegawai order by date_created desc limit 1) as date_created
	...
	public function list_detail() {
		...
		$q = "SELECT p.*, p1.nm_peg1, p2.nm_peg2
				FROM tbl_data_surat_tugas_plh as p
					LEFT JOIN (
	...
	public function detail() {
		...
		$q = "select * 
				from tbl_data_surat_tugas_plh 
				where id_surat_tugas_plh=".$id_surat;
