<?php 
class Klasifikasi_kasus extends CI_Controller{
	...
	public function index() {
		$a['klasifikasi'] 		= $this->db->query("SELECT * from master_jeniskasus")->result();
		$a['page'] = "i/modul_referensi/klasifikasi_kasus/index_klasifikasi_kasus";
