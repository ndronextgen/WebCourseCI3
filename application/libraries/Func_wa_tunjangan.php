...
#----------------------------------- WA EMAIL -------------------------------
#----------------------------------------------------------------------------
function Notifikasi_data($Tunjangan_id){
    $CI = &get_instance();
    #Query_notif_beta
    $Query_data_surat = $CI->db->query("SELECT
                                            a.Id, 
                                            a.id_pegawai, a.lokasi_kerja_pegawai, a.is_dinas, 
                                            a.Tunjangan_id, a.Digaji_menurut, a.Status_progress,
                                        ...
                                        LEFT JOIN (
                                            ...
                                            WHERE a.Id != '' AND Tunjangan_id = '$Tunjangan_id'")->row();
    return $Query_data_surat;
}

function Notifikasi_data_admin($Tunjangan_id){
    $CI = &get_instance();
    #Query_notif_beta
    $Query_data_surat = $CI->db->query("SELECT
                                            a.Id, 
...
function Notifikasi_admin_penerima($Tunjangan_id){
    $CI = &get_instance();
    # Query_notif_beta
    ...
    $Q_Pegawai = $CI->db->query("SELECT lokasi_kerja_pegawai, is_dinas FROM tr_tunjangan 
                                    WHERE Tunjangan_id = '$Tunjangan_id'")->row();
...
function notif_tj_pegawai_tambah($Tunjangan_id){
    $CI = &get_instance();
    ...
    $data_penerima  = $CI->func_wa_tunjangan->Notifikasi_data($Tunjangan_id);
    $Hari 			= $CI->func_wa_tunjangan->gethari(date('l', strtotime($data_penerima->Updated_at)));
    $Tanggal_indo 	= $Hari . ' ' . $CI->func_wa_tunjangan->tgl_indonesia($data_penerima->Updated_at);
    $Jam			= date("H:i:s", strtotime($data_penerima->Updated_at));

    $Sapaan 		= $CI->func_wa_tunjangan->get_sapaan(strtotime(date("H:i:s", strtotime($data_penerima->Updated_at))));
    $data_admin     = $CI->func_wa_tunjangan->Notifikasi_admin_penerima($data_penerima->Tunjangan_id);
// ---- to pegawai
    $message_pegawai = 'Hai <b>' . $data_penerima->nama . '</b>, <br/>
Selamat Anda telah berhasil Tambah <b>Surat Tunjangan Keluarga</b> dalam aplikasi Si-ADiK. <br/><br/>
<b>Isi Surat 		 : Surat Tunjangan Keluarga</b> <br/>
<b>Tanggal 		 : ' . $Tanggal_indo . ' ' . $Jam . ' WIB</b> <br/>
<b>Url 		 	 : https://dcktrp.jakarta.go.id/si-adik</b> <br/>
<b>Status	 	 : ' . $data_penerima->status . '</b> <br/>
'.$CI->func_wa_tunjangan->Get_footer().'
';
    ...
    $objSendMail = sendMail([
        'subject' => 'Si-ADiK (Surat Tunjangan)',
...
' . $Sapaan . ' Pemberitahuan Aplikasi Si-ADiK Terdapat <b>Surat Tunjangan Keluarga</b> baru, Mohon agar dilakukan verifikasi ketahap selanjutnya.<br/><br/>
<b>Isi Surat 		 : Surat Tunjangan Keluarga</b> <br/>
<b>Tanggal 		 : ' . $Tanggal_indo . ' ' . $Jam . ' WIB</b> <br/>
...
function notif_tj_update($id_surat){
    $CI = &get_instance();
    $CI->load->helper('send_email');
    $CI->load->helper('wa');
    // ---------------------------
    $tgl_now = date('Y-m-d H:i:s');
    $data_penerima  = $CI->func_wa_tunjangan->Notifikasi_data_admin($id_surat);
    $Hari 			= $CI->func_wa_tunjangan->gethari(date('l', strtotime($data_penerima->Updated_at)));
    $Tanggal_indo 	= $Hari . ' ' . $CI->func_wa_tunjangan->tgl_indonesia($data_penerima->Updated_at);
    $Jam			= date("H:i:s", strtotime($data_penerima->Updated_at));
    $Sapaan 		= $CI->func_wa_tunjangan->get_sapaan(strtotime(date("H:i:s", strtotime($data_penerima->Updated_at))));
    $data_admin     = $CI->func_wa_tunjangan->Notifikasi_admin_penerima($data_penerima->Tunjangan_id);
    $data_kasubag   = $CI->func_wa_tunjangan->Notifikasi_kasubag();
    $data_sekdis    = $CI->func_wa_tunjangan->Notifikasi_sekdis();
    $data_sudinupt  = $CI->func_wa_tunjangan->Notifikasi_kasubag_sudinupt($data_penerima->lokasi_kerja_pegawai);
    // --------------------------
...
' . $Sapaan . ' Pemberitahuan Aplikasi Si-ADiK terhadap usulan Surat Tunjangan Keluarga anda.<br/><br/>
<b>Isi Surat 		 : Surat Tunjangan Keluarga</b> <br/>
<b>Tanggal 		 : ' . $Tanggal_indo . ' ' . $Jam . ' WIB</b> <br/>
<b>Url 		 	 : https://dcktrp.jakarta.go.id/si-adik</b> <br/>
<b>Status	 	 : ' . $data_penerima->status . '</b> <br/>
...
Selamat Anda telah berhasil Verifikasi <b>Surat Tunjangan Keluarga</b> dalam aplikasi Si-ADiK. <br/><br/>
<b>Isi Surat 		 : Surat Tunjangan Keluarga</b> <br/>
<b>Tanggal 		 : ' . $Tanggal_indo . ' ' . $Jam . ' WIB</b> <br/>
<b>Surat Dari	 : ' . $data_penerima->nama . '</b><br/>
<b>Url 		 	 : https://dcktrp.jakarta.go.id/si-adik</b> <br/>
...
foreach($data_admin as $key){
$message_admin_update = 'Hai <b>' . $key->nama_lengkap . '</b>, <br/>
' . $Sapaan . ' Pemberitahuan Aplikasi Si-ADiK terhadap usulan <b>Surat Tunjangan Keluarga</b>.<br/><br/>
<b>Isi Surat 		 : Surat Tunjangan Keluarga</b> <br/>
<b>Tanggal 		 : ' . $Tanggal_indo . ' ' . $Jam . ' WIB</b> <br/>
<b>Surat Dari	 : ' . $data_penerima->nama . '</b><br/>
<b>Url 		 	 : https://dcktrp.jakarta.go.id/si-adik</b> <br/>
...
// ---- to pegawai terkait #1
$message_pegawai_terkait = 'Hai <b>' . $data_penerima->nama . '</b>, <br/>
' . $Sapaan . ' Pemberitahuan Aplikasi Si-ADiK terhadap usulan Surat Tunjangan Keluarga anda, Surat keterangan sudah dapat diunduh<br/><br/>
<b>Isi Surat 		 : Surat Tunjangan Keluarga</b> <br/>
<b>Tanggal 		 : ' . $Tanggal_indo . ' ' . $Jam . ' WIB</b> <br/>
<b>Url 		 	 : https://dcktrp.jakarta.go.id/si-adik</b> <br/>
<b>Status	 	 : ' . $data_penerima->status . '</b> <br/>
