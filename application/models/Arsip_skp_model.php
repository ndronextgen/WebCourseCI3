...
class Arsip_Skp_model extends CI_Model {



	var $table = 'tbl_arsip_skp';
	...
	var $order = array('id_arsip_skp' => 'desc'); // default order 
	...
	public function get_by_id($id_skp)

	{

		$this->db->from($this->table);

		$this->db->where('id_arsip_skp',$id_skp);
	...
	public function delete_by_id($id_skp)
