...
class Arsip_pelatihan_model extends CI_Model {
	var $table = 'tbl_arsip_pelatihan';
	...
	var $order = array('id_arsip_pelatihan' => 'desc'); // default order 
	...
	{
		$this->db->from($this->table);
		$this->db->where('id_arsip_pelatihan',$id_pelatihan);
		$query = $this->db->get();
	...
	public function get_by_id_ref($id)
	{
		$this->db->from($this->table);
