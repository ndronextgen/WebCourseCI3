jQuery(document).ready(function () {
	...
	var tblTugasPltPlh = $("#tbl_lispltplh").KTDatatable({
		// datasource definition
		data: {
			type: "remote",
			source: {
				read: {
					url: url + "/api/surat_tugas_pltplh/list_detail",
					method: "POST",
		...
		columns: [
			...
			},
			{
				...
				template: function (row) {
					let content = `<a target="_blank" href="${url}admin/surat_tugas_pltplh/cetak/${row.id_surat_tugas_pltplh}/${											row.id_pegawai}" class="btn btn-outline-hover-primary"><i class="flaticon-technology"></i> Cetak</a>
					<a onclick="hapus_surat_tugas_pltplh(${row.id_surat_tugas_pltplh})" class="btn btn-outline-hover-danger">
...
//                   <a href="${url}admin/surat_tugas_pltplh/delete/${el.id_surat_tugas_pltplh}" class="kt-nav__link">
//                     <i class="kt-nav__link-icon la la-trash"></i>
...
//             <td>${el.alasan_pltplh}</td>
//             <td>${el.durasi}</td>
//             <td>${el.tanggal_pengajuan}</td>
//             <td>
//               <span style="overflow: visible; position: relative; width: 110px;">
//                 <a target="_blank" href="${url}admin/surat_tugas_pltplh/cetak/${
// 					el.id_surat_tugas_pltplh
// 				}/${
// 					el.id_pegawai
...
function ubahSuratTugasPlh(id) {
	...
	frm.attr("action", url + "admin/surat_tugas_pltplh/edit");
