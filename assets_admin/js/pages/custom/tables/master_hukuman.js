jQuery(document).ready(function () {
  ...
  var tbl = $('#tbl').KTDatatable({
    ...
    data: {
      type: 'remote',
      source: url+'/api/master/mst_hukuman/list',
      pageSize: 20,
    },
    // layout definition
    layout: {
        ...
        template: function(row) {
          var content = `
            <span style="overflow: visible; position: relative; width: 171px;">
              <a href="${url}admin/master_hukuman/detail/${row.id_hukuman}" class="btn btn-outline-hover-primary"><i class="flaticon-eye"></i> Lihat Detail</a>
                ...
                <div class="dropdown-menu dropdown-menu-sm" style="">
                  ...
                  <ul class="kt-nav">
                    <li class="kt-nav__item kt-nav__item--active">
                      <a href="${url}admin/master_hukuman/edit/${row.id_hukuman}" class="kt-nav__link">
                        <i class="kt-nav__link-icon la la-edit"></i>
                        <span class="kt-nav__link-text">Ubah Data</span>
                      </a>
                    </li>
                    <li class="kt-nav__item">
                      <a href="${url}admin/master_hukuman/hapus/${row.id_hukuman}" onClick="return confirm('Anda yakin..???');" class="kt-nav__link">
