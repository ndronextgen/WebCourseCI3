jQuery(document).ready(function () {
  ...
  var tbl = $('#tbl').KTDatatable({
    ...
    data: {
      type: 'remote',
      source: url+'/api/master/mst_penghargaan/list',
      pageSize: 20,
    },
    // layout definition
    layout: {
        ...
        template: function(row) {
          var content = `
            <span style="overflow: visible; position: relative; width: 171px;">
              <a href="${url}admin/master_penghargaan/detail/${row.id_master_penghargaan}" class="btn btn-outline-hover-primary"><i class="flaticon-eye"></i> Lihat Detail</a>
                ...
                <div class="dropdown-menu dropdown-menu-sm" style="">
                  ...
                  <ul class="kt-nav">
                    <li class="kt-nav__item kt-nav__item--active">
                      <a href="${url}admin/master_penghargaan/edit/${row.id_master_penghargaan}" class="kt-nav__link">
                        <i class="kt-nav__link-icon la la-edit"></i>
                        <span class="kt-nav__link-text">Ubah Data</span>
                      </a>
                    </li>
                    <li class="kt-nav__item">
                      <a href="${url}admin/master_penghargaan/hapus/${row.id_master_penghargaan}" onClick="return confirm('Anda yakin..???');" class="kt-nav__link">
