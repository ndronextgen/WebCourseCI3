jQuery(document).ready(function () {
  ...
  var tbl = $('#tbl').KTDatatable({
    ...
    data: {
      type: 'remote',
      source: url+'/api/master/mst_status_pegawai/list',
      pageSize: 20,
    },
    // layout definition
    layout: {
        ...
        template: function(row) {
          var content = `
            <span style="overflow: visible; position: relative; width: 171px;">
              <a href="${url}admin/master_status_pegawai/detail/${row.id_status_pegawai}" class="btn btn-outline-hover-primary"><i class="flaticon-eye"></i> Lihat Detail</a>
                ...
                <div class="dropdown-menu dropdown-menu-sm" style="">
                  ...
                  <ul class="kt-nav">
                    <li class="kt-nav__item kt-nav__item--active">
                      <a href="${url}admin/master_status_pegawai/edit/${row.id_status_pegawai}" class="kt-nav__link">
                        <i class="kt-nav__link-icon la la-edit"></i>
                        <span class="kt-nav__link-text">Ubah Data</span>
                      </a>
                    </li>
                    <li class="kt-nav__item">
                      <a href="${url}admin/master_status_pegawai/hapus/${row.id_status_pegawai}" onClick="return confirm('Anda yakin..???');" class="kt-nav__link">
