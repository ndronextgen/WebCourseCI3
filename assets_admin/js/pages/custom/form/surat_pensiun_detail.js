    ...
    $('#btnProses').click(function(e) {
      ...
      .then(name => {
        ...
        $.ajax({
          ...
          url: url+'admin/surat_pensiun/processSave',
          data: param,
          dataType: 'json',
          method: 'POST',
        ...
        if (file.length > 0){
          ...
          if (doc != '') {
            ...
            $.ajax({
              ...
              url: url+'admin/surat_pensiun/processUpload',
              data: param,
              dataType: 'json',
              method: 'POST',
              success: function(resp) {
...
function download_surat() {
  ...
  $.ajax({
    ...
    url: url+'admin/surat_pensiun/updateDownload',
    data: param,
    dataType: 'json',
    method: 'POST',
    success: function(resp) {
      if (resp.status == true) {
        ...
        setTimeout(function() {
          url += 'admin/surat_pensiun/download_surat/'+$('#id_surat').val();
